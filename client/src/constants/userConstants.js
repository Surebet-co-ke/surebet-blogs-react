...
export const USER_QUICK_CREATE_REQUEST = 'USER_QUICK_CREATE_REQUEST';
export const USER_QUICK_CREATE_SUCCESS = 'USER_QUICK_CREATE_SUCCESS';
export const USER_QUICK_CREATE_FAIL = 'USER_QUICK_CREATE_FAIL';
...
export const USERS_STATS_REQUEST = 'USERS_STATS_REQUEST';
export const USERS_STATS_SUCCESS = 'USERS_STATS_SUCCESS';
export const USERS_STATS_FAIL = 'USERS_STATS_FAIL';
